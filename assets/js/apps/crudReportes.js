 ...
 * 
 * data
 * todos los hooks del lifecycle (created, mounted, etc)
 * methods
 * computed
 * props
 * emits
  ...
  methods: {
    async levantarReporte() {
      ...
      if (this.email == '' || this.email.length < 5) {
        toastr.error('Completa tu correo electrÃ³nico por favor.');
        errores++;
      }

      if (this.problema == '' || this.problema.length < 5) {
        toastr.error('Ingresa una descripciÃ³n del problema de mÃ¡s de 5 caracteres por favor.');
        errores++;
      }
    ...
    <div className="card-body">
      <form v-on:submit.prevent="levantarReporte">
        <div className="mb-2 row">
          ...
          <div className="col-12 col-md-6">
            <label htmlFor="email" className="form-label">Tu correo electrÃ³nico <span className="text-danger">*</span></label>
            <input 
            type="email" 
            v-model="email" 
            className="form-control" 
        ...
        <div class="mb-2">
          <label for="problema" class="form-label">Â¿CuÃ¡l es el problema del equipo? <span className="text-danger">*</span></label>
          <textarea
            v-model="problema"
            class="form-control"
            id="problema"
...
const listadoComponent = {
  ...
  <div className="card">
    ...
    <div className="card-body">
      <span v-if="procesando">ðŸš€ Cargando informaciÃ³n ...</span>
...
const mainComponent = {
  ...
  methods: {
    ...
    async resolverReporte(id) {
      // Definir que algo se estÃ¡ procesando
      this.procesando = true;
