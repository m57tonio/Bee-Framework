...
<div class="container">
  <div class="row">
    <div class="col-12 col-md-6 text-center offset-md-3 py-5">
      ...
      <p class="mt-3 text-muted"><?php echo $d->data->topic ?></p>

      <div class="card mt-5 shadow">
        <div class="card-header bg-white border-bottom-0">
          <h2>Generar cotización - <?php echo sprintf('Clase #%s', $d->data->number); ?></h2>
        </div>
        <div class="card-body text-start">
          <?php echo Flasher::flash(); ?>

          <form action="apps_example/post-generar-reporte" method="post">
            ...
            <div class="mb-3 d-flex flex-column">
              <?php foreach ($d->data->concepts as $c): ?>
